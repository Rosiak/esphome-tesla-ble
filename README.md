...
- **update_interval**: This is the base polling rate. **No other polls can happen faster than this even if you configure them shorter.** The VCSEC (Vehicle Controller Secondary) system is polled at this rate and does not wake the car. [Default 10s]
...
- **poll_data_period**: The vehicle is polled every this parameter seconds when awake. Note the vehicle can stay awake if this is set too short [Default 60s]
